...
// Widget SocialLogin để hiển thị các nút đăng nhập qua mạng xã hội
class SocialLogin extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.spaceBetween, // Phân bố khoảng cách giữa các phần tử
      children: [
        // Phần hiển thị dòng chữ "Đăng nhập với"
        Container(
          margin: EdgeInsets.fromLTRB(0, 0, 0, 34), // Khoảng cách dưới cùng
          child: Align(
            alignment: Alignment.topCenter, // Căn giữa theo chiều ngang
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center, // Căn giữa các phần tử trong hàng
              crossAxisAlignment: CrossAxisAlignment.center, // Căn giữa theo chiều dọc
              children: [
                // Dòng kẻ bên trái của văn bản
                Container(
                  margin: EdgeInsets.fromLTRB(0, 0, 4, 0), // Khoảng cách bên phải
                  child: Container(
                ...
                Container(
                  margin: EdgeInsets.symmetric(horizontal: 2), // Khoảng cách bên trái và phải
                  child: Text(
                    'Đăng nhập với',
                    style: TextStyle(
                ...
                Container(
                  margin: EdgeInsets.fromLTRB(4, 0, 0, 0), // Khoảng cách bên trái
                  child: Container(
                    decoration: BoxDecoration(
                      color: Color(0xE0939393), // Màu xám nhạt
                    ),
                ...
                child: Container(
                  ...
                  child: ClipOval(
                    child: Material(
                      ...
                      child: InkWell(
                        splashColor: Colors.grey.withOpacity(0.2), // Màu hiệu ứng khi nhấn
                        child: Image.asset(
